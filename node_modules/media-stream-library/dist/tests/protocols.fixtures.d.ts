...
export declare const rtcpSRBuffers: Buffer[];
export declare const rtcpRRBuffers: Buffer[];
export declare const rtcpSDESBuffers: Buffer[];
export declare const rtcpBYEBuffers: Buffer[];
export declare const rtcpAPPBuffers: Buffer[];
