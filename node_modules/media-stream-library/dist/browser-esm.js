...
var require_stream_writable = __commonJS({
  "../node_modules/readable-stream/lib/_stream_writable.js"(exports, module) {
    ...
    if (typeof Symbol === "function" && Symbol.hasInstance && typeof Function.prototype[Symbol.hasInstance] === "function") {
      ...
      Object.defineProperty(Writable6, Symbol.hasInstance, {
        value: function value(object) {
          ...
          if (this !== Writable6) return false;
    ...
    function Writable6(options) {
      ...
      if (!isDuplex && !realHasInstance.call(Writable6, this)) return new Writable6(options);
    ...
    function endWritable(stream, state, cb) {
      ...
      finishMaybe(stream, state);
      if (cb) {
        if (state.finished) process_browser.nextTick(cb);
  ...
  "../node_modules/readable-stream/lib/_stream_duplex.js"(exports, module) {
    ...
    require_inherits_browser()(Duplex2, Readable8);
    {
      ...
      for (v = 0; v < keys.length; v++) {
        method = keys[v];
        if (!Duplex2.prototype[method]) Duplex2.prototype[method] = Writable6.prototype[method];
      }
    }
    var keys;
    var method;
...
var require_stream_readable = __commonJS({
  "../node_modules/readable-stream/lib/_stream_readable.js"(exports, module) {
    ...
    Readable8.prototype.pipe = function(dest, pipeOpts) {
      ...
      if (state.endEmitted) process_browser.nextTick(endFn);
...
var require_stream_transform = __commonJS({
  "../node_modules/readable-stream/lib/_stream_transform.js"(exports, module) {
    ...
    function Transform11(options) {
      if (!(this instanceof Transform11)) return new Transform11(options);
...
var BoxBuilder = class {
  ...
  moof(metadata) {
    ...
    const duration = trackData.lastTimestamp !== 0 ? Math.max(0, timestamp2 - trackData.lastTimestamp | 0) : trackData.defaultFrameDuration;
